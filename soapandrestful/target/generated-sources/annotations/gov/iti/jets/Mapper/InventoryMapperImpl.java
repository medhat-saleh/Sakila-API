...
public class InventoryMapperImpl implements InventoryMapper {
    ...
    protected Rentaldto rentalToRentaldto(Rental rental) {
        ...
        rentaldto.setInventory( todto( rental.getInventory() ) );
    ...
    protected Rental rentaldtoToRental(Rentaldto rentaldto) {
        ...
        rental.setInventory( toentity( rentaldto.getInventory() ) );
    ...
    protected Set<Inventory> inventorydtoSetToInventorySet(Set<Inventorydto> set) {
        ...
        for ( Inventorydto inventorydto : set ) {
            set1.add( toentity( inventorydto ) );
        }
