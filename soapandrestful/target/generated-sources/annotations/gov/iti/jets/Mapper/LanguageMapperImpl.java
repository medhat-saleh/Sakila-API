...
public class LanguageMapperImpl implements LanguageMapper {
    ...
    protected Filmdto filmToFilmdto(Film film) {
        ...
        filmdto.setLanguageByLanguageId( todto( film.getLanguageByLanguageId() ) );
        filmdto.setLanguageByOriginalLanguageId( todto( film.getLanguageByOriginalLanguageId() ) );
    ...
    protected Film filmdtoToFilm(Filmdto filmdto) {
        ...
        film.setLanguageByLanguageId( toentity( filmdto.getLanguageByLanguageId() ) );
        film.setLanguageByOriginalLanguageId( toentity( filmdto.getLanguageByOriginalLanguageId() ) );
