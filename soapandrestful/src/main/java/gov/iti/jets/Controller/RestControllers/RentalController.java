...
public class RentalController {
    ...
    @Path("{id}")
    public Response getRentalById(@PathParam("id") Short id) {
        try {
    ...
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    public Response addRenal(Rentaldto rentaldto) {
        try {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    public Response UpdateRenal(Rentaldto rentaldto ) {
        try {
    ...
    @DELETE
    @Path("{id}")
    public Response DeleteRentalById(@PathParam("id") Short id) {
        try {
